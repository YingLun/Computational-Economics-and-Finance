...
figure
subplot(2,1,1)
plot(1:size(x_history,2),x_history(1,:))
hold on
plot([1,size(x_history,2)],[k_star,k_star],'k')
xlim([1,size(x_history,2)])
title('k')

subplot(2,1,2)
plot(1:size(x_history,2),x_history(2,:))
hold on
plot([1,size(x_history,2)],[h_star,h_star],'k')
xlim([1,size(x_history,2)])
title('h')
